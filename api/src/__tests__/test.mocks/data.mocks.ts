...
export const tasks = [
  ...
  {
    id: '28',
    description: 'Take a picture of the most beautiful building on your street',
  },
...
export const tasksOrder = tasks.reduce((accumulator, current) => {
  accumulator[current.id] = current;
  return accumulator;
}, {});

export const tasksStatus = tasks.reduce((accumulator, current, index) => {
  if (index === 0) {
